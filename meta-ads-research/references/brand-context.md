> **This is a loadable brand context file.** Replace the contents below with your brand's taxonomy to get brand-mapped reports and creative briefs. The Table Clay example below shows the expected structure — product lines, angle enums, personas, objection targets, and proof types. Your file should follow the same format with your brand's specifics.
>
> When no brand context file is provided, the meta-ads-research skill works generically and skips the brand-mapping phase.
